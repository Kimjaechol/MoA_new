# MoA — Architecture v8 (테마별 재구성판)

> **Version**: v8.0 (Thematic Restructure — 테마별 재구성)
> **Status**: Living document — 기존 `ARCHITECTURE.md` 의 전 내용을 13개 주제축으로 재배치한 문서.
> **Audience**: AI reviewers, human contributors, future maintainers, 제품/비즈니스 기획자
>
> **원본 문서와의 관계**:
>
> - [`docs/ARCHITECTURE.md`](./ARCHITECTURE.md) — 원본 문서(순차 번호 체계, §1~§16). 버전 히스토리는 [`docs/architecture-changelog.md`](./architecture-changelog.md) 로 분리됨.
> - 본 문서(v8) — 동일 내용을 다음 13개 테마로 재구성:
...
> - **내용 누락 없음**: 원본의 모든 섹션이 본 문서 어딘가에 포함되어 있으며, 헤더 레벨만 한 단계씩 내려 재배치되었습니다.
>
> **Change log**: [`docs/architecture-changelog.md`](./architecture-changelog.md)
